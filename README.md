...
| Папка | Содержимое |
|---|---|
| `01-business-model/` | Контекстная диаграмма, BUC, глоссарий |
| `02-requirements/` | Use Case, domain model, спецификации сценариев |
| `03-architecture/` | Архитектурный подход, PCMEF, интерфейсы |
| `04-database/` | ER-диаграмма, DDL, структура БД |
| `05-design/` | Диаграммы последовательностей |
| `06-implementation/` | Реализация backend и mobile, структура кода, тесты |
| `07-ui/` | Скриншоты интерфейсов |
| `08-final/` | Итоговые материалы: техническая спецификация, руководство пользователя, презентация |
