...
> В загруженном архиве нет `.git`-истории, поэтому диаграммы ниже построены по содержимому репозитория и структуре документации. Это полезная сводка для защиты и сверки состава проекта.
